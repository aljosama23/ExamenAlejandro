...
<body>
    ...
    <br>
    <a href="<?php echo e(route('asiento.agregar')); ?>" class="btn btn-success">Agregar Nuevo</a>
    <br>
    <table class="table">
        <thead>
            <tr>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo e($asiento->preio); ?></td>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <tr>
                    ...
                    <td>A</td>
                    <td>
                        <a href="<?php echo e(route('asiento.vistaeditar')); ?>">Editar</a>
                    </td>
                    <td>
                        <a>Eliminar</a>
                    </td>
...
</html><?php /**PATH C:\wamp64\www\ExamenAlejandro\resources\views/tiposAsientos.blade.php ENDPATH**/ ?>